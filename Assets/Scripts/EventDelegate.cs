...
public class EventDelegate
{
	...
	public bool isValid => (mRawDelegate && mCachedCallback != null) || (mTarget != null && !string.IsNullOrEmpty(mMethodName));

	public bool isEnabled => (mRawDelegate && mCachedCallback != null) || (mTarget != null && mTarget.enabled);
	...
	{
		Add(list, callback, oneShot: false);
	}
