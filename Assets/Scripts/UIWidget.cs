...
public class UIWidget : UIRect
{
	...
	public bool isVisible => mIsVisible && mIsInFront;
	...
	public void ResizeCollider()
	{
		if (NGUITools.GetActive(this))
		{
			...
			if (boxCollider != null)
			{
				NGUITools.UpdateWidgetCollider(boxCollider, considerInactive: true);
			}
		}
	}
	...
	public bool UpdateGeometry(int frame)
	{
		...
		{
			mChanged = false;
			if (mIsVisible && num > 0.001f && shader != null)
			{
