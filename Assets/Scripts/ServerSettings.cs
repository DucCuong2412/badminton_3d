...
public class ServerSettings : ScriptableObject
{
	...
	public static readonly string[] CloudServerRegionPrefixes = new string[4]
	{
		"app-eu",
		"app-us",
		"app-asia",
	...
	public string Region => ExtractRegionFromAddress(ServerAddress);
	...
	public static string ExtractRegionFromAddress(string address)
	{
		...
		UnityEngine.Debug.Log("Extracted region: " + text);
		return text;
	}
	...
	public static bool TryParseCloudServerRegion(string regionShortcut, out CloudServerRegion region)
	{
		...
		try
		{
			region = (CloudServerRegion)Enum.Parse(typeof(CloudServerRegion), regionShortcut, ignoreCase: true);
		}
		catch
		{
			return false;
