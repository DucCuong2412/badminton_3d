  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: BASE
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.xlv_TEXCOORD1 = mul(mul(unity_MatrixV, unity_ObjectToWorld), tmpvar_2).xyz;
          return out_v;
      }
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 tmpvar_4;
          tmpvar_4 = texCUBE(_ToonShade, in_f.xlv_TEXCOORD1);
          cube_1 = tmpvar_4;
          float4 tmpvar_5;
          tmpvar_5.xyz = ((2 * cube_1.xyz) * tmpvar_3.xyz);
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: BASE
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.xlv_TEXCOORD0 = TRANSFORM_TEX(in_v.texcoord.xy, _MainTex);
          out_v.xlv_TEXCOORD1 = in_v.texcoord.xyz;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          float4 col_1;
          col_1 = (tex2D(_MainTex, in_f.xlv_TEXCOORD0) * _Color);
          col_1.xyz = (texCUBE(_ToonShade, in_f.xlv_TEXCOORD1) * col_1).xyz;
          col_1 = (col_1 * 2);
          col_1.w = col_1.w;
          out_f.color = col_1;
          return out_f;
